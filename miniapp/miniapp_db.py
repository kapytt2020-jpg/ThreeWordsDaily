"""
database.py — SQLite async database for Voodoo
Uses aiosqlite. DB file: voodoo.db
"""
...
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "voodoo.db")
...
async def init_db():
    async with aiosqlite.connect(DB_PATH) as db:
        await db.executescript("""
            ...
            -- (SQLite doesn't support IF NOT EXISTS on ALTER TABLE, handled below)
