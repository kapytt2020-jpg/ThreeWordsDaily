...
// ThreeWordsDaily Mini App — Full product
...
const LEXI_STAGES = [
  ...
  },
  {
    ...
    speech: ['Я пишаюся тобою! 🔮✨', 'Ти — Легенда ThreeWordsDaily!', 'Рідкісна форма розблокована!', 'Хочу ще складніших слів!'],
  ...
  },
  {
    ...
    speech: ['ФІНАЛЬНА ФОРМА! ⚡', 'Ти — Майстер ThreeWordsDaily!', 'Нічого більше нема... Хіба що повчити ще?'],
